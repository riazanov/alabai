...
/**
 * Extends {@link alabai_je.SidePremise} with the possibility of 
 * enumerating all factoring inferences between the active literal and 
 * one or more passive literals; this kind of premise objects is 
 * primarily for use with the resolution rule; potentially, it
 * may also be used with other rules, such as transitive chaining.
 */
public class SidePremiseWithFactoring extends SidePremise {

    public
    SidePremiseWithFactoring(NewClauseAssembler residualLiteralAssembler) {
     ...
     *  @return false if all possible factoring inferences
     *          have been made
     */
    ...
    public Flatterm activeLiteralFlatterm() {
...
}; // class SidePremiseWithFactoring
