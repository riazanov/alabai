...
package logic.is.power.alabai;
   ...
   * wrt the LHS term.
   */
  class FinSelUnEqLHSForParamodG extends FinSelUnEqLHSForParamod {

    /** <b>pre:</b> literal is a positive equality <code> &&
     *	(argumentNumber == 0 || argumentNumber == 1)</code>.
     */
      public FinSelUnEqLHSForParamodG(Clause clause,
				      Literal literal,
				      int argumentNumber) {
	  super(FineSelectionUnit.Kind.EqLHSForParamodG,
		clause,
		literal,
		argumentNumber);
      }
  ...
  }; // class FinSelUnEqLHSForParamodG
