 ...
 */
public interface VectorClauseFeature extends ClauseFeature {

    public int[] evaluate(Collection<Literal> cl);

    public int[] evaluateTemp(Collection<TmpLiteral> cl);   
    
    /** The (constant) size of the results computed by this feature function. */ 
    public int size(); 

} // interface VectorClauseFeature