...
/**
 * Implements heuristic-controlled selection of literals and maximal 
 * sides in equalities.
 */
class LiteralAndEqHeadSelection implements SimpleReceiver<Clause> {

    public LiteralAndEqHeadSelection(SimpleReceiver<Clause> outputReceiver) {
...
}; // class LiteralAndEqHeadSelection
