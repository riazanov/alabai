 ...
 * <a href="{@docRoot}/../glossary.html#side_premise">side premises</a>
 ...
 * convenient for factoring and for identifying 
 ...
 * <b>IMPORTANT:</b> When a clause is loaded in this object, no variable 
 *            renaming takes place, ie, all variables are left intact;
 *            At the same time, the current global substitution is applied
 *            to the passive literals (for efficiency).
 */
class SidePremise {
    ...
    protected SidePremise(NewClauseAssembler residualLiteralAssembler) {
	...
	for (Literal lit : cl.literals())
		...
		_literalAssembler.pushLiteralWithGlobSubst(lit.isPositive(),
							   lit.atom());
	...
	activeLiteral.atom().collectFreeVariables(_activeLiteralVariableSet);
